...
// StatisticProvider
$statistic_provider = new StatisticProvider("Text://0.0.0.0:55868");
$statistic_provider->name = 'StatisticProvider';
// StatisticWorker
$statistic_worker = new StatisticWorker("Statistic://0.0.0.0:55666");
$statistic_worker->transport = 'udp';
$statistic_worker->name = 'StatisticWorker';
// WebServer
$web = new WebServer("http://0.0.0.0:55767");
$web->name = 'StatisticWeb';
$web->addRoot('air-plus.cn', __DIR__.'/Web');
// recv udp broadcast
$udp_finder = new Worker("Text://0.0.0.0:55868");
