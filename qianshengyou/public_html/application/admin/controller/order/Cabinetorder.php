 ...
 * @icon fa fa-circle-o
 */
class Cabinetorder extends Backend
{
    
    /**
     * Cabinetorder模型对象
     * @var \app\admin\model\Cabinetorder
     */
    ...
    public function _initialize()
    {
        ...
        $this->model = new \app\admin\model\Cabinetorder;
...
//                     ->with(['users','netpoint','entity','device'])
                    ->where($where)
                    ->order($sort, $order)
                    ->count();
    ...
    public function rtncabinet()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            try {
                ...
                $this->error('后台还柜发生异常:'.$e->getMessage());
            }
        }
