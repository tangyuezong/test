<?php
define("USER", "kongzhongzuche");
define("PASSWORD", "200888cxmxj");
...
class ShortMsg
{
    ...
    // APPID
    private $appId = "947cf6e1fa0a47a7b3b98b81254f3f82";
    
    //开发者账号ID。由32个英文字母和阿拉伯数字组成的开发者账号唯一标识符。
    private $accountSid = "d8ede5cf763da8a3134d0c0b88b01d28";
    
    //开发者账号TOKEN
    private $token = "301692a29bb4e71a3c6a3ab39677fca8";
...
//         }
     ...
     * @throws Exception
     */
    public function SendSms($templateid,$mobile,$param=null){
