<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/www/web/qianshengyou/public_html/public/../application/admin/view/dashboard/index.html";i:1557390875;s:76:"/www/web/qianshengyou/public_html/application/admin/view/layout/default.html";i:1557390875;s:73:"/www/web/qianshengyou/public_html/application/admin/view/common/meta.html";i:1557390875;s:75:"/www/web/qianshengyou/public_html/application/admin/view/common/script.html";i:1557390875;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="row">
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span id="totaluser"><?php echo $totaluser; ?></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span id="totaldevice"><?php echo $totaldevice; ?></span>
                                <?php echo __('Total device'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span id="totalorder"><?php echo $totalorder; ?></span>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="sm-st clearfix">
                            ...
                            <div class="sm-st-info">
                                <span id="totalorderamount"><?php echo $totalorderamount; ?></span>
                            ...
                            <div class="card-block">
                                <div class="row row-sm stats-container">
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            <div id="todayusersignup" class="value"> <?php echo $todayusersignup; ?> </div>
                                    ...
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            <div id="todayuserlogin" class="value"> <?php echo $todayuserlogin; ?> </div>
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        ...
                                        <div class="stat">
                                            <div id="todayorder" class="value"> <?php echo $todayorder; ?> </div>
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        ...
                                        <div class="stat">
                                            <div id="unsettleorder" class="value"> <?php echo $unsettleorder; ?> </div>
                                    ...
                                    <div class="col-xs-6  stat-col">
                                        ...
                                        <div class="stat">
                                            <div id="sevendnu" class="value"> <?php echo $sevendnu; ?> </div>
                                    ...
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            <div id="sevendau" class="value"> <?php echo $sevendau; ?> </div>
...
<script>
	$(function () {
	    ...
	    try {
	    	$.ajax({
                url: "/admin/dashboard/usercount",
                dataType: 'json',
                success: function(ret) {
                	$("#totaluser").text(ret.data);
                },
                fail: function(e) {
                }
            });
	    ...
	    try {
	    	$.ajax({
                url: "/admin/dashboard/devcount",
                dataType: 'json',
                success: function(ret) {
                	$("#totaldevice").text(ret.data);
                },
                fail: function(e) {
                }
            });
	    ...
	    try {
	    	$.ajax({
                ...
                dataType: 'json',
                success: function(ret) {
                	$("#totalorder").text(ret.data.totalorder);
                	$("#totalorderamount").text(ret.data.totalorderamount);
                },
                fail: function(e) {
                }
            });
	    ...
	    try {
	    	$.ajax({
                url: "/admin/dashboard/todayregister",
                dataType: 'json',
                success: function(ret) {
                	$("#todayusersignup").text(ret.data);
                },
                fail: function(e) {
                }
            });
	    ...
	    try {
	    	$.ajax({
                url: "/admin/dashboard/todaylogin",
                dataType: 'json',
                success: function(ret) {
                	$("#todayuserlogin").text(ret.data);
                },
                fail: function(e) {
                }
            });
	    ...
	    try {
	    	$.ajax({
                url: "/admin/dashboard/todayorder",
                dataType: 'json',
                success: function(ret) {
                	$("#todayorder").text(ret.data);
                },
                fail: function(e) {
                }
            });
	    ...
	    try {
	    	$.ajax({
                url: "/admin/dashboard/unsettleorder",
                dataType: 'json',
                success: function(ret) {
                	$("#unsettleorder").text(ret.data);
                },
                fail: function(e) {
                }
            });
	    ...
	    try {
	    	$.ajax({
                url: "/admin/dashboard/sevendnudau",
                dataType: 'json',
                success: function(ret) {
                	$("#sevendnu").text(ret.data.dnu);
                	$("#sevendau").text(ret.data.dau);
                },
                fail: function(e) {
                }
            });
