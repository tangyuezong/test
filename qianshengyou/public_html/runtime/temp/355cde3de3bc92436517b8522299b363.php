<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/web/qianshengyou/public_html/public/../application/index/view/index/index.html";i:1584509698;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <body id="page-top">
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="#page-top"><img src="/assets/img/onetolink.png" style="width:200px;" alt=""></a>
                </div>
        ...
        <footer>
            <div class="container">
                ...
                <p>&copy; 2017-2018 <a href="https://share.zj-qsy.com" target="_blank">千生佑陪护</a>.	<a href="http://www.beian.miit.gov.cn">19018759号-1</a></p>
                    ...
                    if (!installed) {
                        $.ajax({
                            ...
                            data: {
                                ...
                                tpversion: "<?php echo THINK_VERSION; ?>" . "<?php echo config('fastadmin.customer'); ?>",
