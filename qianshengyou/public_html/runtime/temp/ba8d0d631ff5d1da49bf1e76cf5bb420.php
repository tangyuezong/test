<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:93:"/www/web/qianshengyou/public_html/public/../application/admin/view/device/devinrepo/edit.html";i:1557390875;s:76:"/www/web/qianshengyou/public_html/application/admin/view/layout/default.html";i:1557390875;s:73:"/www/web/qianshengyou/public_html/application/admin/view/common/meta.html";i:1557390875;s:75:"/www/web/qianshengyou/public_html/application/admin/view/common/script.html";i:1557390875;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <!-- <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-price_id" data-rule="required" data-source="price/index" class="form-control selectpage form-control" name="row[price_id]" type="text" value="<?php echo $row['price_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Netpoint_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-netpoint_id" data-rule="required" data-source="netpoint/index" class="form-control selectpage form-control" name="row[netpoint_id]" type="text" value="<?php echo $row['netpoint_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Entity_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-entity_id" data-rule="required" data-source="entity/index" class="form-control selectpage form-control" name="row[entity_id]" type="text" value="<?php echo $row['entity_id']; ?>">
        </div>
    </div> -->
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Devtype_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-devtype_id" data-rule="required" data-source="device/devtype/index" class="form-control selectpage form-control" name="row[devtype_id]" type="text" value="<?php echo $row['devtype_id']; ?>">
        </div>
    </div>
    <div class="form-group">
